...
/**
 *  Async response handler decorator to run interceptors.
 *
 * @param <T> the type of the result
 */
@SdkInternalApi
public final class AsyncInterceptorCallingResponseHandler<T> implements TransformingAsyncResponseHandler<T> {
    private final TransformingAsyncResponseHandler<T> delegate;
    private final ExecutionContext context;

    public AsyncInterceptorCallingResponseHandler(TransformingAsyncResponseHandler<T> delegate, ExecutionContext context) {
